			...
			<div class="main clearfix" @mouseover="btnOpen" @mouseout="btnHide">
				...
				<div class="btnMain" v-show="btnShow">
					<div class="left" @click="leftClick">
						<img src="../assets/homePics/leftArrow.png"/>
					</div>
					<div class="right" @click="rightClick">
						<img src="../assets/homePics/rightArrow.png" />
					</div>
				</div>
				<div class="pressMain">
...
export default {
  ...
  data() {
    return {
      list: [
        { imgUrl: require("../assets/homePics/picture1.jpg") },
        { imgUrl: require("../assets/homePics/picture2.jpg") },
        { imgUrl: require("../assets/homePics/picture3.jpg") },
        { imgUrl: require("../assets/homePics/picture4.jpg") },
        { imgUrl: require("../assets/homePics/picture5.jpg") },
      ],
      pressList: [
        { name: "1", isShow: false },
        { name: "2", isShow: false },
